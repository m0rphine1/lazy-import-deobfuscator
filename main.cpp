...
int main() {
    ...
    std::vector<obfuscated_import_t> obfuscated_imports = FindObfuscatedImports(binary->get_content_from_virtual_address(0x140002400, 0x5000).data(), 0x140002400, 0x5000);
